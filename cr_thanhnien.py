...
elems = driver.find_elements(By.CSS_SELECTOR, '.box-category-middle .box-category-item .box-category-content .box-category-link-title')
title = [elem.text for elem in elems]
links = [elem.get_attribute('href') for elem in elems]

# Find elements with product details
types = driver.find_elements(By.CSS_SELECTOR, '.box-category-middle .box-category-item .box-category-content .box-category-category')
type = [elem.text for elem in types]

# Find elements with product details
contents = driver.find_elements(By.CSS_SELECTOR, '.box-category-middle .box-category-item .box-category-content .item-related .box-category-related-link-title')
...
excel_file_path = f'excel_thanhnien_{current_date}.xlsx'
