...
driver.get('https://nld.com.vn/kinh-te/bat-dong-san.htm')
...
elems = driver.find_elements(By.CSS_SELECTOR, '.box-category-item .box-category-content h3 a')
...
excel_file_path = f'{current_date}_nld_with_content.xlsx'
df.to_excel(excel_file_path, index=False, engine='openpyxl')

print(f"Data has been saved to {excel_file_path}")

# py cr_content_nld.py
