...
for index, row in df.head(max_rows).iterrows():
    ...
    try:
        elements_with_tags = driver.find_elements(By.CSS_SELECTOR, '.tagdetail .row2')
        ...
        date_div = driver.find_element(By.CSS_SELECTOR, ".dateandcat span[data-role='publishdate']")
...
excel_file_path = f'{current_date}_cafe_with_content.xlsx'
df.to_excel(excel_file_path, index=False, engine='openpyxl')

print(f"Data has been saved to {excel_file_path}")

# py cr_content_cafe.py
