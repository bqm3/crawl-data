...
elems = driver.find_elements(By.CSS_SELECTOR, '.box-category[data-layout="4"] .box-category-middle .box-category-item .box-category-link-title')
title = [elem.text for elem in elems]
links = [elem.get_attribute('href') for elem in elems]

# # Find elements with product details
# types = driver.find_elements(By.CSS_SELECTOR, '.box-category[data-layout="4"] .box-category-middle .box-category-item .box-category-sapo')
# type = [elem.text for elem in types]

# Find elements with product details
contents = driver.find_elements(By.CSS_SELECTOR, '.box-category[data-layout="4"] .box-category-middle .box-category-item .box-category-sapo')
...
excel_file_path = f'excel_soha_{current_date}.xlsx'
